...
docker exec -it host_1 route add default gw 172.22.0.5
docker exec -it host_2 route add default gw 172.22.0.5
docker exec -it host_3 route add default gw 172.22.0.5
...
docker exec -it host_4 route add default gw 172.23.0.5
docker exec -it host_5 route add default gw 172.23.0.5
docker exec -it host_6 route add default gw 172.23.0.5
